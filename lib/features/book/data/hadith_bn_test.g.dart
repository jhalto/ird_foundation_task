...
class Book extends DataClass implements Insertable<Book> {
  ...
  Book copyWith({
    ...
    numberOfHadis: numberOfHadis.present
        ? numberOfHadis.value
        : this.numberOfHadis,
...
abstract class _$HadithDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [books, chapter, hadith];
}
...
class $$BooksTableFilterComposer
    extends Composer<_$HadithDatabase, $BooksTable> {
...
class $$BooksTableTableManager
    extends
        RootTableManager<
          ...
          (Book, BaseReferences<_$HadithDatabase, $BooksTable, Book>),
          Book,
          PrefetchHooks Function()
        > {
  $$BooksTableTableManager(_$HadithDatabase db, $BooksTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$ChapterTableFilterComposer
    extends Composer<_$HadithDatabase, $ChapterTable> {
...
class $$ChapterTableTableManager
    extends
        RootTableManager<
          ...
          (
            ChapterData,
            BaseReferences<_$HadithDatabase, $ChapterTable, ChapterData>,
          ),
          ChapterData,
          PrefetchHooks Function()
        > {
  $$ChapterTableTableManager(_$HadithDatabase db, $ChapterTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
class $$HadithTableFilterComposer
    extends Composer<_$HadithDatabase, $HadithTable> {
...
class $$HadithTableTableManager
    extends
        RootTableManager<
          ...
          (
            HadithData,
            BaseReferences<_$HadithDatabase, $HadithTable, HadithData>,
          ),
          HadithData,
          PrefetchHooks Function()
        > {
  $$HadithTableTableManager(_$HadithDatabase db, $HadithTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$HadithTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$HadithTableCreateCompanionBuilder,
      $$HadithTableUpdateCompanionBuilder,
      (HadithData, BaseReferences<_$HadithDatabase, $HadithTable, HadithData>),
      HadithData,
      PrefetchHooks Function()
    >;
